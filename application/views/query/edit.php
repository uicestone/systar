	...
	<div class="contentTableBox">
		<div class="contentTable">
			...
			<div class="item autocomplete-no-result-menu" style="display: block;">
				...
				<input type="text" name="source[detail]" value="<? displayPost('source/detail') ?>" disabled="disabled" placeholder="具体来源" style="width:32%;display:none" />
			...
			<div class="item">
				...
				<input type="text" name="case_lawyer_extra[partner_name]" value="<? displayPost('case_lawyer_extra/partner_name')?>" title="督办合伙人" placeholder="督办合伙人" style="width:33%" />
	
				<input type="text" name="case_lawyer_extra[lawyer_name]" value="<? displayPost('case_lawyer_extra/lawyer_name')?>" title="接洽律师" placeholder="接洽律师" style="width:32%" />
	
				<input type="text" name="case_lawyer_extra[assistant_name]" value="<? displayPost('case_lawyer_extra/assistant_name')?>" title="协助接洽" placeholder="协助接洽" style="width:32%" />
	
			</div>
			
			<div class="item">
				<div class="title"><label>概况：</label></div>
				<textarea name="query[summary]" rows="7"><? displayPost('query/summary'); ?></textarea>
			</div>
	
			<div class="item">
				<div class="title"><label>报价：</label></div>
				<input type="text" name="query[quote]" value="<? displayPost('query/quote');?>" />
			</div>
			
			<div class="item">
				<div class="title"><label>备注：</label></div>
				<textarea name="query[comment]"><? displayPost('query/comment'); ?></textarea>
			</div>

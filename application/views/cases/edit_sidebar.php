...
<? if(($this->user->isLogged('manager') || (isset($people_roles[$this->user->id]) && in_subarray('督办人', $people_roles[$this->user->id], 'role'))) && in_array('等待立案审核',$labels) && $project['type']==='cases'){?>

...
$(function(){
	chart_staffly_clients = new Highcharts.Chart($.extend(true,{},highchartsOptions,{
		...
		xAxis: {
			categories: $.parseJSON('<? echo $chart_staffly_clients_catogary?>')
		},
		series: $.parseJSON('<? echo $chart_staffly_clients_series?>')
	}));
});
</script>
<div class="contentTableBox" style="width:100%">
	<? arrayExportTable($client_collect_stat,NULL,false,false) ?>

...
* @property SS_Input $input
* @property CI_Language $language
* @property SS_Loader $load
* @property CI_Log $log
* @property SS_Model $model
* @property SS_Output $output
* @property CI_Pagination $pagination
* @property CI_Parser $parser
* @property CI_Profiler $profiler
* @property CI_Router $router
* @property SS_Session $session
...
* @property Achievement_model $achievement
* @property Cases_model $cases
* @property Classes_model $classes
* @property Client_model $client
* @property Company_model $company
* @property Contact_model $contact
* @property Document_model $document
